...
func newBoardsItemsRemoveTagFromCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagTagId, "tag-id", "", "Unique identifier (ID) of the tag that you want to remove from the item.")
