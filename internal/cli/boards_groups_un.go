...
func newBoardsGroupsUnCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().BoolVar(&flagDeleteItems, "delete-items", false, "Indicates whether the items should be removed. By default, false.")
