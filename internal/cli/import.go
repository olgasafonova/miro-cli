...
but do not stop the import.`,
  ...
  miro-developer-platform-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  miro-developer-platform-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | miro-developer-platform-pp-cli import <resource> --input -`,
