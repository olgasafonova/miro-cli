...
func newOrgsCasesEditCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyDescription, "description", "", "The description of the case.")
	cmd.Flags().StringVar(&bodyName, "name", "", "The name of the case.")
