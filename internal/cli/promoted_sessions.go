...
func newSessionsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  miro-cli sessions --email user@example.com",
	...
	cmd.Flags().StringVar(&flagEmail, "email", "", "Email ID of the user whose sessions you want to reset. Note that this user will be signed out from all devices.")
