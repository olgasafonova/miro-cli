...
native streaming instead of polling.`,
  ...
  miro-developer-platform-pp-cli tail --interval 10s

  # Tail a specific resource
  miro-developer-platform-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  miro-developer-platform-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
