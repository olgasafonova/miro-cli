		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export MIRO_ACCESS_TOKEN=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("MIRO_ACCESS_TOKEN") != "" {
				authEnvSet = append(authEnvSet, "MIRO_ACCESS_TOKEN")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "MIRO_ACCESS_TOKEN")
			}
			switch {
