...
func newV2ExperimentalGetMindmapNodesExperimentalCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagLimit, "limit", "", "Maximum number of results returned")
	cmd.Flags().StringVar(&flagCursor, "cursor", "", "Points to the next portion of the results set")
