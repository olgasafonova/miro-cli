...
// PostWithParams sends a POST with both query params and a JSON body. Use
// when an endpoint declares parameters with `in: query` alongside a request
// body (e.g. `POST /v2/boards/{id}/items/{id}?tag_id=...`).
